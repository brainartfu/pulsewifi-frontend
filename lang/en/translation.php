...
return [
    ...
    "distributor-onboard" => "Distributor Onboard",
    "manage-distributors" => "Manage Distributors",
    "franchises" => "Franchises",
    "franchise-onboard" => "Franchise Onboard",
    "manage-franchisees" => "Manage Franchisees",
    "pdos" => "PDOs",
    "pdo-setup" => "PDO Setup",
    "manage-pdos" => "Manage PDOs",
    "pdo-requests" => "PDO Requests",
    "pdoas" => "PDOAs",
    "pdoa-onboard" => "PDOA Onboard",
    "manage-pdoas" => "Manage PDOAs",
    ...
    "stocks-&-inventory" => "Stocks & Inventory",
    ...
    "finance" => "Finance",
    "approve-payouts" => "Approve Payouts",
    ...
    "user-session-report" => "User Session Report",
    "roaming-report" => "Roaming Report",
    "revenue-share-reports" => "Revenue Share Reports",
    "distributor-revenue-reports" => "Distributor Revenue Reports",
    "franchise-revenue-reports" => "Franchise Revenue Reports",
    "logs" => "Logs",
    "pdo-logs" => "PDO Logs",
    "user-access-logs" => "User Access Logs",
    "user-recharge-logs" => "User Recharge Logs",
    "nat-logs" => "NAT Logs",
    "email-logs" => "Email Logs",
    "sms-logs" => "SMS Logs",
    "transaction-logs" => "Transaction Logs",
    "distributor-logs" => "Distributor Logs",
    "franchise-logs" => "Franchise Logs",
    "settings" => "Settings",
    ...
    "payout-gateways" => "Payout Gateways",

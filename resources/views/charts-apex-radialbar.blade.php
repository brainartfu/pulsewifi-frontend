...
@section('title')
    @lang('translation.Apex_Radialbar_Chart')
@endsection
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div id="multiple_radialbar"
                        data-colors='["--vz-primary", "--vz-success", "--vz-secondary", "--vz-info"]' class="apex-charts"
                        dir="ltr"></div>
                </div><!-- end card-body -->
            </div><!-- end card -->
        </div>
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="circle_radialbar"
                        data-colors='["--vz-primary", "--vz-primary-rgb, 0.65", "--vz-primary-rgb, 0.45", "--vz-primary-rgb, 0.30"]'

                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 overflow-hidden">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="text-truncate mb-0 fs-15"><a class="text-reset username"
                                        ...
                                        <div class="conversation-list">
                                            ...
                                            <div class="user-chat-content">
                                                <div class="ctext-wrap">
                                                    <div class="ctext-wrap-content shadow-none">
                            ...
                            <form id="chatinput-form" enctype="multipart/form-data">
                                <div class="row g-0 align-items-center">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control chat-input bg-light border-light fs-13"
                                    ...
                                    <div class="col-auto">
                                        <div class="chat-input-links ms-2">
                                            <div class="links-list-item">
                                                <button type="submit"
                                                    class="btn btn-success chat-send waves-effect waves-light fs-13">

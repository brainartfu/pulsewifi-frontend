    ...
    <form id="createproduct-form" autocomplete="off" class="needs-validation" novalidate>
        <div class="row">
            <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3">
                                <div class="mb-3">
                                    <label class="form-label" for="product-title-input">Stock Title</label>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Stock Gallery</h5>
                        </div>
                        <div class="card-body">
                            <div class="mb-4">
                                <h5 class="fs-14 mb-1">Stock Image</h5>
                                <p class="text-muted">Add Stock main Image.</p>
                            ...
                            <div>
                                <h5 class="fs-14 mb-1">Stock Gallery</h5>
                                <p class="text-muted">Add Stock Gallery Images.</p>
                                            ...
                                            <div class="d-flex p-2">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar-sm bg-light rounded">
                                                        <img data-dz-thumbnail class="img-fluid rounded d-block" src="#" alt="Stock-Image" />
                                                    </div>
                                                </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Stock Categories</h5>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Stock Tags</h5>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Stock Short Description</h5>
                    </div>
                    <div class="card-body">
...
@section('script')
    ...
    <script src="{{ URL::asset('assets/js/pages/inventory/stock.js') }}"></script>

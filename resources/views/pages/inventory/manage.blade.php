                ...
                <div class="card-header border-0">
                    <div class="row g-4">
                        <div class="col-sm-auto">
                            <div>
                                <a href="/inventory/add-stock" class="btn btn-success" id="addproduct-btn"><i class="ri-add-line align-bottom me-1"></i> Add Stock</a>
                            </div>
                        </div>
                        <div class="col-sm">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                    ...
                    <button type="button" class="btn w-sm btn-primary " id="delete-product">Yes, Delete It!</button>
                </div>
            </div>

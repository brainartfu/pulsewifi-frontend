...
@section('title') Distributor Onboard @endsection
@section('css')
...
@slot('title') Distributor Onboard @endslot
@endcomponent
<div class="row">
    <div class="col">
                            ...
                            <form class="vertical-navs-step">
                                <div class="row gy-5">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <ul class="list-group mb-3" id="distributor-cart-detail">
...
<script src="{{ URL::asset('assets/js/pages/service/distributoronboard.init.js') }}"></script>

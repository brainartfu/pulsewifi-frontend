...
@slot('title') PDOA onboard @endslot
@endcomponent
<div class="row">
    <div class="col-lg-12">
        <div class="card" id="tasksList">
            <div class="card-header border-0">
                <div class="d-flex align-items-center">
                    <h5 class="card-title mb-0 flex-grow-1">Create PDOA</h5>
                </div>
            </div>
        </div>
    </div>
                ...
                <form class="vertical-navs-step">
                    <div class="row gy-5">
                                ...
                                <div class="tab-content">
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="cin_no" placeholder="Enter CIN No">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="mb-3">
                                    ...
                                    <div class="tab-pane fade" id="oq-3" role="tabpanel" aria-labelledby="oq-3-tab">
                                        ...
                                        <div class="d-flex align-items-start gap-3 mt-4">
                                            ...
                                            <button type="button" class="btn btn-success btn-label right ms-auto nexttab nexttab" data-nexttab="oq-4-tab" data-currtab="oq-3"><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>
                                                Submit Pdoa And Continue to Payment</button>
                                        </div>
                                    </div>
                                    <!-- end tab pane -->
                                    <div class="tab-pane fade" id="oq-4" role="tabpanel" aria-labelledby="oq-4-tab">
                                        ...
                                        <div>
                                            ...
                                            <div class="d-flex align-items-start gap-3 mt-4">
                                                <button type="button" class="btn btn-light btn-label previestab" data-previous="oq-3-tab" data-currtab="oq-4"><i class="ri-arrow-left-line label-icon align-middle fs-16 me-2"></i>Back to Choose Package</button>
                        ...
                        <div class="col-lg-3">
                            ...
                            <ul class="list-group mb-3" id="pdoa-cart-detail">
...
@endsection
@section('script')
<script src="{{ URL::asset('assets/js/pages/service/pdoaonboard.init.js') }}"></script>

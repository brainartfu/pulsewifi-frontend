        ...
        <div class="card card-animate">
            <div class="card-body" id="pending-widget">
                ...
                <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="">0</span></h4>
                        <span class="badge bg-primary me-1">0</span> <span class="text-muted">Pending Subscribers</span>
                    </div>
                    <div class="avatar-sm flex-shrink-0">
                        <span class="avatar-title bg-light rounded fs-3">
    ...
    <div class="col-lg-12">
        <div class="card" id="tasksList">
            <div class="card-header border-0">
                <div class="d-flex align-items-center">
                    <h5 class="card-title mb-0 flex-grow-1">All Subscribers</h5>
                    <div class="flex-shrink-0">
                        <button class="btn btn-soft-primary add-btn" onclick="AddSubscriber()" data-bs-toggle="modal" data-bs-target="#SubscriberModal"><i class="ri-add-line align-bottom me-1"></i> Create Subscriber</button>
                        <button class="btn btn-soft-primary" data-bs-toggle="modal" data-bs-target="#deleteModal"><i class="ri-delete-bin-2-line"></i></button>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header p-3">
                <h5 class="modal-title text-uppercase" id="SubscriberModalLabel">Edit Subscriber</h5>
                    ...
                    <div class="step-arrow-nav">
                        <ul class="nav nav-pills nav-justified custom-nav" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link p-3 active" id="oq-1-tab" data-bs-toggle="pill" data-bs-target="#oq-1" type="button" role="tab" aria-controls="oq-1" aria-selected="true">Subscriber Details</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link p-3" id="oq-2-tab" data-bs-toggle="pill" data-bs-target="#oq-2" type="button" role="tab" aria-controls="oq-2" aria-selected="false">Packages</button>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="oq-2" role="tabpanel" aria-labelledby="oq-2-tab">
                            ...
                            <div class="row g-3">
                                <div class="col-6">
                                    <label class="form-label" for="active_package">Active Package</label>
                                    <input type="text" class="form-control" id="active_package" placeholder="Enter Active Package">
                                </div>
                                <div class="col-6">
                                    <label class="form-label" for="package_status">Package Status</label>
                                    <input type="text" class="form-control" id="package_status" placeholder="Enter Package Status">
                                </div>
                                <div class="col-6">
                                    <label class="form-label" for="data_consume">Data Consume</label>
                                    <input type="text" class="form-control" id="data_consume" placeholder="Enter Data Consume">
                                </div>
                                <div class="col-6">
                                ...
                                <div class="col-6">
                                    <label class="form-label" for="connected_devices">Connected Devices</label>
                                    <input type="text" class="form-control" id="connected_devices" placeholder="Enter Connected Devices">
                                </div>
                                <div class="col-6">
                                    <label class="form-label" for="expired_at">Expired At</label>
                                    <input type="text" class="form-control" id="expired_at" placeholder="Enter Connected Devices">
                                </div>
                                <div class="col-6">
                                    <label class="form-label" for="last_recharged">Last Recharged</label>
                                    <input type="text" class="form-control" id="last_recharged" placeholder="Enter Connected Devices">
                                </div>

                                <!--end col-->
                                <div class="col-lg-12">
                                    <div class="hstack align-items-start gap-3 mt-4">
                                        <button type="button" class="btn btn-light btn-label previestab" data-previous="oq-1-tab" data-currtab="oq-2"><i class="ri-arrow-left-line label-icon align-middle fs-16 me-2"></i>Back to Subscriber Details</button>
                                        <button type="button" class="btn btn-primary btn-label right ms-auto nexttab" data-nexttab="oq-3-tab" data-currtab="oq-2"><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Submit</button>
                                    </div>
                                </div>
                                <!--end col-->
                            </div>
        ...
        <div class="modal-content">
            <div class="modal-body p-5 text-center">
                ...
                <div class="mt-4 text-center">
                    <h4>You are about to delete a subscriber ?</h4>
                    <p class="text-muted fs-15 mb-4">Deleting your subscriber will remove all of
...
<script src="{{ URL::asset('assets/js/pages/service/subscribersList.init.js') }}"></script>

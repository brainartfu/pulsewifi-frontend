...
@slot('li_1') PDOAs @endslot
@slot('title') PDOA List @endslot
@endcomponent
<div class="row">
        ...
        <div class="card" id="tasksList">
            <div class="card-header border-0">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0">
                        <button class="btn btn-soft-primary add-btn" data-bs-toggle="modal" data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i> Create PDOA</button>
                    ...
                    <div class="tab-content">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-lg-12">
                                    <div class="d-flex align-items-start gap-3 mt-3">
                                        <button type="button" class="btn btn-primary btn-label right ms-auto nexttab" data-nexttab="pills-bill-address-tab"><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i> Next
                                            Step</button>
                                    </div>
                                </div>
                                <!--end col-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="hstack align-items-start gap-3 mt-4">
                                        ...
                                        <button type="button" class="btn btn-primary btn-label right ms-auto nexttab" data-nexttab="pills-payment-tab"><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Next
                                            Step</button>
                                    </div>
                                </div>
                                <!--end col-->
                        ...
                        <div class="tab-pane fade" id="pills-payment" role="tabpanel" aria-labelledby="pills-payment-tab">
                            ...
                            <div class="d-flex align-items-start gap-3 mt-4">
                                <button type="button" class="btn btn-light btn-label previestab" data-previous="pills-bill-address-tab"><i class="ri-arrow-left-line label-icon align-middle fs-16 me-2"></i>Back to Bank
                                    Details</button>
                        ...
                        <div class="tab-pane fade" id="pills-finish" role="tabpanel" aria-labelledby="pills-finish-tab">
                            <div class="row text-center justify-content-center py-4">
                                <div class="col-lg-11">
                                    <div class="mb-4">
                                        <lord-icon src="https://cdn.lordicon.com/lupuorrc.json" trigger="loop" colors="primary:#25a0e2,secondary:#00bd9d" style="width:120px;height:120px">
                                        </lord-icon>
                                    </div>
                                    ...
                                    <div class="hstack justify-content-center gap-2">
                                        <button type="button" class="btn btn-ghost-primary" data-bs-dismiss="modal">Done <i class="ri-thumb-up-fill align-bottom me-1"></i></button>
    ...
    const setPdoaListHtml = (data) => {
        ...
        if (data.length) {
            $.each(data, (index, row) => {
                ...
                $html += `<td class="client_name">
                        <div class="dropdown">
                            <button class="btn btn-soft-secondary btn-sm dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="ri-more-fill align-middle"></i>
                            </button>
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><button class="dropdown-item" href="javascript:void(0);" onclick="ViewInvoice(this);" data-id="` + row.id + `" ><i class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                        View</button></li>
                                <li><button class="dropdown-item" href="javascript:void(0);" onclick="EditInvoice(this);" data-id="` + row.id + `" data-bs-toggle="modal"
    ...
    const setPdoaWidgetsData = () => {
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#total-widget .counter-value').attr('data-target', response.data.total_users);

                $('#active-widget .me-1').html(response.data.cur_week_users);
                $('#active-widget .counter-value').html(response.data.cur_week_users);
                $('#active-widget .counter-value').attr('data-target', response.data.cur_week_users);

                $('#limit-widget .me-1').html(response.data.expired_users);
                $('#limit-widget .counter-value').html(response.data.expired_users);
                $('#limit-widget .counter-value').attr('data-target', response.data.expired_users);
            },
        });
    };
</script>

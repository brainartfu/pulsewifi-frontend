...
@slot('title') Franchise List @endslot
@endcomponent
        ...
        <div class="card card-animate">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        <p class="fw-medium text-muted mb-0">Total Franchises</p>
    ...
    <div class="col-xxl-3 col-sm-6">
        <div class="card card-animate">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        <p class="fw-medium text-muted mb-0">Pending Franchises</p>
    ...
    <div class="col-xxl-3 col-sm-6">
        <div class="card card-animate">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        <p class="fw-medium text-muted mb-0">Completed Franchises</p>
    ...
    <div class="col-xxl-3 col-sm-6">
        <div class="card card-animate">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        <p class="fw-medium text-muted mb-0">Deleted Franchises</p>
        ...
        <div class="card" id="tasksList">
            <div class="card-header border-0">
                <div class="d-flex align-items-center">
                    <h5 class="card-title mb-0 flex-grow-1">All Franchises</h5>
                    <div class="flex-shrink-0">
                        <a href="{{URL::asset('/service/franchise/franchise-onboard')}}" class="btn btn-soft-primary add-btn"><i class="ri-add-line align-bottom me-1"></i> Create Franchise</a>
                    ...
                    <div class="row g-3">
                        <div class="col-xxl-5 col-sm-12">
                            <div class="search-box">
                                <input type="text" class="form-control search bg-light border-light" placeholder="Search for Franchises or something...">
                    ...
                    <table class="table align-middle table-nowrap mb-0" id="tasksTable">
                        <thead class="table-light text-muted">
                            <tr>
                                ...
                                <th class="sort text-uppercase">Distributor</th>
                                <th class="sort text-uppercase">Total Locations</th>
                                <th class="sort text-uppercase">Total Locations Online</th>
                                <th class="sort text-uppercase">Status</th>
                                <th class="sort text-uppercase">Action</th>
                            </tr>
                        </thead>
                        <tbody class="list form-check-all" id="franchises-list">
                            <tr>
...
<div class="modal fade zoomIn" id="editFranchiseModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header p-3">
                <h5 class="modal-title text-uppercase" id="exampleModalLabel">Edit Franchise</h5>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="oq-1" role="tabpanel" aria-labelledby="oq-1-tab">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="belongs_to">Belongs To</label>
...
<script src="{{ URL::asset('assets/js/pages/service/franchiselist.init.js') }}"></script>

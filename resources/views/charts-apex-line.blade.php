    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="line_chart_datalabel" data-colors='["--vz-primary", "--vz-info"]' class="apex-charts"
                        dir="ltr"></div>
                </div><!-- end card-body -->
            </div><!-- end card -->
        </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="line_chart_dashed" data-colors='["--vz-primary", "--vz-info", "--vz-success"]'
    ...
    <div class="row">
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="line_chart_missing_data" data-colors='["--vz-primary", "--vz-info", "--vz-success"]'
                        class="apex-charts" dir="ltr"></div>
                </div><!-- end card-body -->
            </div><!-- end card -->
        </div>

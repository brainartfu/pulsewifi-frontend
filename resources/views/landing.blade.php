                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="card">
                                <div class="card-body text-center p-4">
                                    ...
                                    <!-- end card body -->
                                    <h5 class="mb-1"><a href="{{URL::asset('/pages-profile')}}" class="text-body">Nancy
                                            Martino</a></h5>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="card">
                                <div class="card-body text-center p-4">
                                    ...
                                    <!-- end card body -->
                                    <h5 class="mb-1"><a href="{{URL::asset('/pages-profile')}}" class="text-body">Henry
                                            Baird</a></h5>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="card">
                                <div class="card-body text-center p-4">
                                    ...
                                    <!-- end card body -->
                                    <h5 class="mb-1"><a href="{{URL::asset('/pages-profile')}}" class="text-body">Frank
                                            Hook</a></h5>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="card">
                                <div class="card-body text-center p-4">
                                    ...
                                    <!-- end card body -->
                                    <h5 class="mb-1"><a href="{{URL::asset('/pages-profile')}}" class="text-body">Donald
                                            Palmer</a></h5>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="card">
                                <div class="card-body text-center p-4">
                                    ...
                                    <!-- end card body -->
                                    <h5 class="mb-1"><a href="{{URL::asset('/pages-profile')}}" class="text-body">Erica
                                            Kernan</a></h5>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="card">
                                <div class="card-body text-center p-4">
                                    ...
                                    <!-- end card body -->
                                    <h5 class="mb-1"><a href="{{URL::asset('/pages-profile')}}" class="text-body">Alexis
                                            Clarke</a></h5>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="card">
                                <div class="card-body text-center p-4">
                                    ...
                                    <!-- end card body -->
                                    <h5 class="mb-1"><a href="{{URL::asset('/pages-profile')}}" class="text-body">Marie
                                            Ward</a></h5>
                                    <p class="text-muted mb-0 ff-secondary">Full Stack Developer</p>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="card">
                                <div class="card-body text-center p-4">
                                    ...
                                    <!-- end card body -->
                                    <h5 class="mb-1"><a href="{{URL::asset('/pages-profile')}}" class="text-body">Jack
                                            Gough</a></h5>

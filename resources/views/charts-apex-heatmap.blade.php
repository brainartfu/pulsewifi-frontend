            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="live-preview">
                        <div id="basic_heatmap" data-colors='["--vz-info"]' class="apex-charts" dir="ltr"></div>
                    </div>
                </div><!-- end card-body -->
            </div><!-- end card -->
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div id="multiple_heatmap"
                        data-colors='["--vz-primary", "--vz-secondary", "--vz-success", "--vz-info", "--vz-gray-300"]'
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="color_heatmap" data-colors='["--vz-info", "--vz-success", "--vz-primary", "--vz-secondary"]'
                        class="apex-charts" dir="ltr"></div>
                </div><!-- end card-body -->
            </div><!-- end card -->
        </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="shades_heatmap" data-colors='["--vz-primary", "--vz-primary-rgb, 0.45"]' class="apex-charts"
                        dir="ltr"></div>
                </div><!-- end card-body -->
            </div><!-- end card -->
        </div>
